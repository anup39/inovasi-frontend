        ...
        <div className='bg-lightGray mt-6 mb-[50px] max-w-[826px] m-auto'>
          <form>
            ...
            <div className='flex flex-col px-[34px]'>
              ...
              <PhoneInput
                className='p-[10px] rounded-sm w-full bg-white mr-[60px]'
                flags={flags}
                country={'us'}
                value={phone}
                onChange={(phone: string) => setPhone(phone)}
              />
              <label className='font-semibold mb-2 mt-4'>
                {' '}
                Confirm Passwod{' '}
              </label>
              <input
              ...
              <button className='mr-[60px] h-[40px] text-white w-full mt-4 rounded-md bg-gradient-to-r from-footerHeading to-parrot'>
                Confirm
              </button>
              <button className='border mt-4 w-full h-[50px] rounded-md'>
