      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <path
                ...
                fill={`${selectedItem === "dashboard" ? "#fff" : "#757575"}`}
              />
            </svg>
            ...
            <div className={`flex ${sidebarOpened ? "gap-2" : "gap-0"}`}>
              ...
              >
                <path
                  ...
                  fill={`${
                    selectedItem === "suppliermill" ? "#fff" : "#757575"
                  }`}
                />
              </svg>
              <h1
          ...
          <div
            ...
            className={`hover:bg-boxDivider ${
              selectedItem === "supplierplantation"
                ? "bg-gradient-to-r from-footerHeading to-parrot text-white font-semibold"
                : ""
          ...
          >
            ...
            >
              <path
                ...
                fill={`${
                  selectedItem === "supplierplantation" ? "#fff" : "#757575"
                }`}
              />
            </svg>
          ...
          >
            ...
            >
              <path
                ...
                fill={`${selectedItem === "reporting" ? "#fff" : "#757575"}`}
              />
              <path
