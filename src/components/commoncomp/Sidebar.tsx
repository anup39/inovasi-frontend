...
function Sidebar() {
  ...
  return (
    ...
    <div
      className={`relative w-full h-screen bg-white text-grayText transition-transform ease-in transform ${
    ...
    >
      ...
      {/* main container div */}
      <div className="flex flex-col justify-between px-7 py-5 h-full border-r-2 border-gray-100">
        {/* upper with img, main and settings */}
        <div>
          <img className="mx-auto pb-10" src="ivovasi-Logo.png" alt="" />
          <div>
            <p className="pb-5">MAIN</p>
            <div className="flex flex-col gap-5">
              {/* 4 items of dashboard */}
              <div className="p-3 cursor-pointer rounded-xl flex text-white items-center  bg-gradient-to-r from-[#02C685] to-[#8ADF5E]">
                <img className="" src="dashboardIcon.svg" alt="" />
                <h1>Dashboard</h1>
              </div>
              <div
                className="hover:bg-gray-50 cursor-pointer p-3 rounded-xl flex justify-between"
              ...
              <div className={`pl-10 ${millActive ? "block " : "hidden"}`}>
                <ul className="space-y-1 relative">
                  ...
                  <div className="h-[180px] w-1 bg-gray-100 absolute -top-7 -left-4"></div>
              ...
              <div className="hover:bg-gray-50  cursor-pointer p-3 rounded-xl flex gap-2">
          ...
          <div className="mt-10 h-1 bg-gray-100"></div>
          {/* div with settings */}
          <div className="pt-10">
            <p className="uppercase">settings</p>
            <div className="hover:bg-gray-50 cursor-pointer p-3 rounded-xl flex justify-between">
              <div className="flex gap-2">
