...
function Sidebar({ setSidebarOpened, sidebarOpened }: MyComponentProps) {
  ...
  return (
    <div
      className={`relative flex flex-col justify-between h-screen bg-white text-grayText transition-all py-2 ease-out duration-75  ${
      ...
      >
        ...
        >
          ...
          >
            ...
            <h1 className={`font-semibold ${sidebarOpened ? "" : "hidden"} `}>
              Dashboard
            </h1>
          </div>
          {/* supplier mill */}
          ...
          {/* reporting */}
          <div className="hover:bg-gray-50  cursor-pointer py-2 px-3 rounded-xl flex gap-2">
            <svg
              width="16"
              height="20"
              viewBox="0 0 16 20"
          ...
          <div className="flex flex-col px-3 gap-2">
            ...
            <div className="hover:bg-gray-50 cursor-pointer py-2 rounded-xl flex justify-between">
